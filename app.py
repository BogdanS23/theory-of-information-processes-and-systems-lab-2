...
v0 = {
    'C₁': Attr('Потери от роста заболеваемости населения', 0.8),
    'C₂': Attr('Потери сельского хозяйства от воздействия поллютантов', 0.7),
    'C₃': Attr('Потери от изменения природной среды', 0.83),
    'C₄': Attr('Потери из-за ухудшения качества жизни населения', 0.72),
    'C₅': Attr('Потери предприятия от регулирования выбросов', 0.6),
    'C₆': Attr('Износ технологического оборудования', 0.52),
    'C₇': Attr('Возможность использования кредитных ресурсов', 0.48),
    'C₈': Attr('Привлечение зарубежных инвесторов', 0.22),
    'C₉': Attr('Спрос на продукцию предприятия', 0.27),
    'C₁₀': Attr('Сложность найма сотрудников', 0.54),
    'C₁₁': Attr('Деловая репутация компании', 0.2),
    'C₁₂': Attr('Повышенный уровень смога', 0.4),
    'C₁₃': Attr('Задымленность от лесных пожаров', 0.32),
    'C₁₄': Attr('Продолжительный антициклон', 0.14)
}
